...
export const SERVICES = [
  ...
  { title: "Ma’lumotlar bazasi loyihalash", body: "PostgreSQL/MongoDB modeli, indekslar, migratsiyalar va optimallashtirish." },
  { title: "Integratsiyalar (Auth/Payment/3rd‑party)", body: "JWT, OAuth, to‘lovlar va uchinchi tomon servislariga ulash." },
  { title: "Dockerizatsiya & deploy (CI/CD shabloni)", body: "Docker Compose, image versiyalash, testlar bilan xavfsiz release." }
] as const;
